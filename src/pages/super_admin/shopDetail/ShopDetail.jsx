...
import { useShopById, useDeleteShop } from "@/features/shop/hooks/useShop";
    ...
    if (window.confirm("Are you sure you want to delete this shop?")) {
      try {
        ...
        if (response.success) {
          ...
          navigate(ROUTES.SHOP.LIST);
        } else {
          toast({
            title: "Error",
            description: response?.message || "Failed to delete shop",
            variant: "destructive",
          });
        }
      } catch (error) {
        ...
        toast({
          title: "Error",
          description: "An error occurred while deleting the shop",
          variant: "destructive",
        });
      }
    }
