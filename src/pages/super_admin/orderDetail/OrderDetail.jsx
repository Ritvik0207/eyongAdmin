...
import { useUpdateEstimatedDeliveryDate } from "@/features/orders/hooks/useOrders";
...
export function OrderDetail() {
  ...
  const updateEstimatedDeliveryDate = useUpdateEstimatedDeliveryDate();

  const handleUpdateDeliveryDate = () => {
    updateEstimatedDeliveryDate.mutate(
      { orderId, estimatedDeliveryDate: newDeliveryDate },
      {
        onSuccess: () => {
          toast({
            title: "Success",
            description: "Estimated delivery date updated successfully",
          });
          order.shipping_details.estimated_delivery_date = newDeliveryDate;
          setIsEditing(false);
        },
        onError: () => {
          toast({
            title: "Error",
            description: "Failed to update estimated delivery date",
            variant: "destructive",
          });
        },
      }
            ...
            <div className="flex items-center gap-3">
              ...
              {isEditing ? (
                <>
                  ...
                  />
                  <Button onClick={handleUpdateDeliveryDate} className="ml-2">
                    Save
                  </Button>
                </>
              ) : (
